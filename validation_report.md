...
| `app-of-apps-deployment` | Bootstraps the Argo CD app-of-apps hierarchy | No current Application or TaskRun with this exact literal name was found | Argo CD was operational and the downstream Applications were reconciled | INDIRECTLY VALIDATED |
